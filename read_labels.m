function labels = read_labels(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   LABELS = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   LABELS = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   labels = importfile('labels.txt', 1, 1214);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/04/02 18:37:39
